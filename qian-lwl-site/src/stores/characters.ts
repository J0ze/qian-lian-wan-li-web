    ...
    characters: [
      {
        ...
        outfits: [
          new URL('/src/assets/characters/xingqiao.jpg', import.meta.url).href,
        ],
      ...
      },
      {
        ...
        outfits: [
          new URL('/src/assets/characters/ling.jpg', import.meta.url).href,
        ],
        currentOutfitIndex: 0
      },
      {
        ...
        outfits: [
          new URL('/src/assets/characters/ye.jpg', import.meta.url).href,
        ],
        currentOutfitIndex: 0
      },
      {
